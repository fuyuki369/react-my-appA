...
function SyllabusSearch4(){
    ...
    const [searchResults,setSearchResults] = useState([]); //リザルトstate
                ...
                <table>
                    ...
                    <tbody>
                        {searchResults.map((sResult) => (
                            <tr key={sResult.id} onClick={() => setClickedLesson(sResult)}>
                                <td>{sResult.name}</td>
                                <td>{sResult.day}</td>
...
export default SyllabusSearch4;